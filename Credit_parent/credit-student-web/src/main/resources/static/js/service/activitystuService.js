app.service('activitystuService',function($http){
    ...
    this.search=function(page,rows,searchEntity){
        return $http.post('http://localhost:9093/ActivitystuController/search?page='+page+"&rows="+rows, searchEntity);
    }

    //分页 
    this.findPage=function(page,rows){
        return $http.get('http://localhost:9093/ActivitystuController/findPage?page='+page+'&rows='+rows);
    }
